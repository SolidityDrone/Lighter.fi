...
import {IFunctionsClient} from "@chainlink/src/v0.8/functions/v1_0_0/interfaces/IFunctionsClient.sol";
...
abstract contract FunctionsClient is IFunctionsClient {
  ...
  function fulfillRequest(bytes32 requestId, bytes memory response, bytes memory err) public virtual;
